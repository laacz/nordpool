...
$percentColors = [
    ...
    ['pct' => 0.0, 'color' => ['r' => 0x19, 'g' => 0x72, 'b' => 0x0c]],
    ['pct' => 0.5, 'color' => ['r' => 0x36, 'g' => 0x72, 'b' => 0x0c]],
    ['pct' => 1.0, 'color' => ['r' => 0x72, 'g' => 0x0c, 'b' => 0x0c]],
];
...
$translations = [
    ...
    'disclaimer' => [
        'LV' => 'Dati par rītdienu parādās agrā pēcpusdienā vai arī tad, kad parādās. Avots: Nordpool day-ahead stundas spotu cenas, LV. Krāsa atspoguļo cenu sāļumu konkrētajā dienā, nevis visā tabulā. Attēlotais ir Latvijas laiks. Dati pieejami arī kā %s un kā %s.<br/>
        Kontaktiem un jautājumiem: <a href="mailto:apps@didnt.work">apps@didnt.work</a>.',
        'LT' => 'Ryto duomenys pasirodo ankstyvą popietę arba kai tik jie pasirodo. Šaltinis: Nordpool day-ahead valandos spot kainos, LT. Spalva atspindi kainų druskingumą konkrečią dieną, o ne visoje lentelėje. Rodomas Lietuvos laikas. Duomenys taip pat prieinami kaip %s ir kaip %s.<br/>
        Kontaktams ir klausimams: <<a href="mailto:apps@didnt.work">apps@didnt.work</a> (pageidautina latviškai arba angliškai).',
        'EE' => 'Homme andmed ilmuvad varakult pärastlõunal või kui need ilmuvad. Allikas: Nordpool day-ahed tundide spot hinnad, EE. Värv peegeldab hinna soolsust konkreetsel päeval, mitte kogu tabelis. Kuvatakse Eesti aeg. Andmed on saadaval ka %s ja %s kujul. <br/>
    ...
    'subtitle'  => [
        'LV' => 'Nordpool elektrības biržas SPOT cenas šodienai un rītdienai, līdzko tās tiek publicētas.',
        'LT' => 'Nordpool elektros biržos SPOT kainos šiandien ir rytoj, kai tik paskelbtos.',
        'EE' => 'Nordpool elektrihinna börsi SPOT hinnad täna ja homme, kui need on avaldatud.',
    ],
    'it is without VAT' => [
